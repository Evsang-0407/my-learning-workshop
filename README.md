...
| 文件                                                     | 概念                                                            | 核查状态        |
| ------------------------------------------------------ | ------------------------------------------------------------- | ----------- |
| `learning-materials/agent.html`                        | Agent（智能体）：自主决策循环、四组件（大脑/规划/记忆/工具）、与 workflow/Chatbot/RPA 的辨析 | 已人工核查（2026-09-04） |
...
**我人工核查的部分（已于 2026-09-04 完成，各资料页顶的"核查状态"徽章已同步更新）：**
